...
\coordinate (L)   at (-1.25,0.20); % left circle center
\coordinate (Rgt) at ( 1.25,0.20); % right circle center
...
% labels (outside, near top)
\node[lab] at ($ (L) + (-1.85,1.70) $) {$A$};
\node[lab] at ($ (Rgt) + ( 1.85,1.70) $) {$B$};
