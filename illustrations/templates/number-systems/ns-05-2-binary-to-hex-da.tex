...
1101 & 1010\textsubscript{\textcolor{blue}{\scriptsize\ttfamily 2}}\\
};
...
\node[below=6pt of m-1-1] {{\digitfont D\textsubscript{\textcolor{blue}{\scriptsize\ttfamily 16}}}};
\node[below=6pt of m-1-2] {{\digitfont A\textsubscript{\textcolor{blue}{\scriptsize\ttfamily 16}}}};

\node[right=4mm of m-1-2.east] (eq) {$=$};
\node[right=4mm of eq] {{\digitfont DA\textsubscript{\textcolor{blue}{\scriptsize\ttfamily 16}}}};
\end{tikzpicture}
\end{document}
