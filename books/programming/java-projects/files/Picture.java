package lib; /******************************************************************************
 *  Compilation:  javac lib.Picture.java
 *  Execution:    java lib.Picture filename.jpg
 *  Dependencies: none
 *
 ******************************************************************************/
...
/**
 *  The {@code lib.Picture} data type provides a basic capability for manipulating
 ...
 *  The {@code lib.Picture} class is intended for use in the
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code lib.Picture} in your Java classpath.
 ...
 *  provides access to {@code lib.Picture}.
 *
 ...
 *           lib.Picture picture = new lib.Picture("https://introcs.cs.princeton.edu/java/stdlib/mandrill.jpg");
 *           picture.show();
 *       }
 *   }
 *  </pre>
 ...
 *  You can use the following constructors to create new {@code lib.Picture} objects:
 *  <ul>
 ...
 *  <pre>
 *  lib.Picture picture   = new lib.Picture("https://introcs.cs.princeton.edu/java/stdlib/mandrill.jpg");
 *  lib.Picture grayscale = new lib.Picture(picture.width(), picture.height());
 ...
 *
 *  <p><b>Transparency.</b>
 *  Both the {@link Color} and {@code lib.Picture} classes support
 ...
 *
 *  <p><b>Saving files.</b>
 *  The {@code lib.Picture} class supports writing images to a supported
 ...
 *
 *  <p><b>File formats.</b>
 *  The {@code lib.Picture} class supports reading and writing images to any of the
...
public final class Picture implements ActionListener {
    ...
    /**
     * Unit tests this {@code lib.Picture} data type.
