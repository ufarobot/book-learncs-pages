package lib; /******************************************************************************
 *  Compilation:  javac lib.StdPicture.java
 *  Execution:    java lib.StdPicture filename.jpg
 *  Dependencies: lib.Picture.java
 *
 ******************************************************************************/


/**
 *  The {@code lib.StdPicture} class provides static methods for manipulating
 ...
 *  The {@code lib.StdPicture} class is intended for early usage in the
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code lib.StdPicture} in your Java classpath.
 ...
 *  provides access to {@code lib.StdPicture}.
 *
 ...
 *
 *  <li> Download <a href = "https://introcs.cs.princeton.edu/java/stdlib/lib.StdPicture.java">lib.StdPicture.java</a>
 *  and
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/lib.Picture.java">lib.Picture.java</a>
 ...
 *           lib.StdPicture.read("https://introcs.cs.princeton.edu/java/stdlib/mandrill.jpg");
 *           lib.StdPicture.show();
 *       }
 *   }
 *  </pre>
 ...
 *  <pre>
 *  lib.StdPicture.read("https://introcs.cs.princeton.edu/java/stdlib/mandrill.jpg");
 *  for (int col = 0; col &lt; lib.StdPicture.width(); col++) {
 *      for (int row = 0; row &lt; lib.StdPicture.height(); row++) {
 *          int r = lib.StdPicture.getRed(col, row);
 *          int g = lib.StdPicture.getGreen(col, row);
 *          int b = lib.StdPicture.getBlue(col, row);
 *          int y = (int) (Math.round(0.299*r + 0.587*g + 0.114*b));
 *          lib.StdPicture.setRGB(col, row, y, y, y);
 *      }
 *  }
 *  lib.StdPicture.show();
 *  </pre>
 *
 *  <p><b>Transparency.</b>
 *  The {@code lib.StdPicture} class supports transparent images, using the
 ...
 *
 *  <p><b>Saving files.</b>
 *  The {@code lib.StdPicture} class supports writing images to a supported
 ...
 *
 *  <p><b>File formats.</b>
 *  The {@code lib.StdPicture} class supports reading and writing images to any of the
...
public final class StdPicture {
    ...
    public static void read(String filename) {
        ...
        // same dimension, so copy pixels instead of using new lib.Picture and GUI
        ...
        // different dimension, so need to use new lib.Picture and GUI
        ...
        // no GUI, so use the new lib.Picture
        else {
            picture = newPicture;
        }
    }
...
*/
    ...
    /**
     * Unit tests this {@code lib.StdPicture} data type.
